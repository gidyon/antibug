...
proto_compile_all: proto_compile_pathogen proto_compile_antimicrobial proto_compile_facility proto_compile_account proto_compile_culture

run_app:
	go run cmd/gateway/*.go

run_account:
	cd cmd/modules/account && go build -o service && ./account -config-file=/home/gideon/go/src/github.com/gidyon/antibug/configs/account.dev.yml

run_antimicrobial:
	cd cmd/modules/antimicrobial && go build -o service && ./antimicrobial -config-file=/home/gideon/go/src/github.com/gidyon/antibug/configs/antimicrobial.dev.yml

run_culture:
	cd cmd/modules/culture && go build -o service && ./culture -config-file=/home/gideon/go/src/github.com/gidyon/antibug/configs/culture.dev.yml

run_facility:
	cd cmd/modules/facility && go build -o service && ./facility -config-file=/home/gideon/go/src/github.com/gidyon/antibug/configs/facility.dev.yml

run_pathogen:
	cd cmd/modules/pathogen && go build -o service && ./pathogen -config-file=/home/gideon/go/src/github.com/gidyon/antibug/configs/pathogen.dev.yml
