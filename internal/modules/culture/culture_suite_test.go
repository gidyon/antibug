...
func TestCultureService(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Service Suite")
}

var (
	CultureAPI    culture.CultureAPIServer
	CultureServer *cultureAPIServer
)
...
var _ = AfterSuite(func() {
	Expect(CultureServer.sqlDB.Close()).ShouldNot(HaveOccurred())
})
