...
func TestAntimicrobialService(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Service Suite")
}

var (
	AntimicrobialAPI    antimicrobial.AntimicrobialAPIServer
	AntimicrobialServer *antimicrobialAPIServer
)
...
var _ = AfterSuite(func() {
	Expect(AntimicrobialServer.sqlDB.Close()).ShouldNot(HaveOccurred())
})
