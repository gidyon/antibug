...
func TestFacilityService(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Service Suite")
}

var (
	FacilityAPI    facility.FacilityAPIServer
	FacilityServer *facilityAPIServer
)

const (
	dbName         = "antibug"
	dbAddressLocal = "localhost:3306"
...
var _ = AfterSuite(func() {
	Expect(FacilityServer.sqlDB.Close()).ShouldNot(HaveOccurred())
})
